...
model = joblib.load(r"C:\Users\Vishwa\Desktop\GUVI captone\CAR\gradient_boosting_model_1.joblib")

# Load the dataset to get unique values for dropdowns
data = pd.read_csv(r"C:\Users\Vishwa\Desktop\GUVI captone\CAR\dropped_dataset.csv")
...
def main():
    ...
    set_background_image(r"C:\Users\Vishwa\Desktop\GUVI captone\CAR\toyotacorolla.jpg")  # Replace with your image file path
